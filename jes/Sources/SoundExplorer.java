 ...
 *
 * <br>Modified 19 July 2007 Pamela Cutter Kalamazoo College
 *   <br>&nbsp&nbsp Modified the code so that a sound would display correctly,
 *      using either a 0 or a 1 as the base.  Set the base to
 *      be 1, since that is consistent with how students work with
 *      sounds.
 *
 * <br><br>Kalamazoo code merged by Buck Scharfnorth 22 May 2008
 *
 * Changed base to use the value SimpleSound._SoundIndexOffset (29 Oct 2008) -Buck
 */
