 ...
 public class HighlightingStyledDocument extends DefaultStyledDocument
{
    ...
    /**
     * getLineStart
     * Finds the start of a line in a document.  Takes in an offset and
     * finds the index of the beginning of that line.
    ...
    /**
     * Method: setEnvironmentWordStyle
     ...
     * @return True if it's an env word

     */
    public boolean isEnvWord(String word)
    {
        return environmentWords.contains(word);
    }
